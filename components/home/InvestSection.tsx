  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(173.79% 141.62% at 100.09% -0.08%, rgba(255, 255, 255, 0.40) 0%, rgba(255, 255, 255, 0.00) 100%)',
          backdropFilter: 'blur(15px)',
        }}
      >
        <div className="flex items-start justify-between mb-3 sm:mb-4">
          <div className="flex-1 flex items-center gap-1.5 sm:gap-2">
            <h3 className="text-[13px] sm:text-[14px] lg:text-[16px] font-bold text-white">{title}</h3>
            <p className="text-[12px] sm:text-[13px] lg:text-[15px] text-gray-400">{token}</p>
          </div>
          <span
          ...
          >
            {status === 'allowlist' ? (
              <>
                ...
                <span
                  style={{
                    background: 'linear-gradient(90deg, #A855F7 0%, #60A5E0 50%, #36E8CA 100%)',
        ...
        <p className="text-xs sm:text-sm md:text-base text-[#D9D9D9] leading-relaxed mb-4 sm:mb-5 lg:mb-6">{description}</p>
  ...
  const projects = [
    {
      ...
      description: "KpopRoad's 300-NFT collection offers exclusive K-pop access, VIP rewards, and virtual events.",
      totalRaised: '$200,000',
    ...
    },
    {
      ...
      description: "K-LovePet is a blockchain platform connecting pet lovers through digital assets, events, and rewards.",
      totalRaised: '$200,000',
      targetRaised: 'Finished!',
      saleType: 'Vanguard',
    },
    {
      ...
      token: '$RHCrd',
      status: 'allowlist' as const,
      description: "Royal Heritage Card preserves culture and creates elegance through exclusive membership benefits.",
      totalRaised: '$500,000',
      targetRaised: 'Finished!',
      saleType: 'Vanguard',
    },
    ...
    <section className="relative w-full py-12 sm:py-16 lg:py-20 bg-[#1E1E1E]">
      <div className="w-full max-w-[1440px] mx-auto px-5 sm:px-6">
        ...
        >
          ...
          >
            Exclusive access to high-growth startups, elite venture funds, and private market deals across both traditional tech (Web2) and next-generation blockchain innovations (Web3).
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
