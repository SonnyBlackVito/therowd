...
export default function HowToStartInvestSection() {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden pt-18 sm:pt-25 lg:pt-30 pb-18 sm:pb-25 lg:pb-30">
      ...
      <div className="relative z-10 w-full max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <motion.div
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex gap-4 sm:gap-6">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="min-w-0 relative flex-[0_0_100%] sm:flex-[0_0_85%] lg:flex-[0_0_75%] max-w-211 mx-auto">
...
function ArticleSection() {
  return (
    <div className="relative w-full mt-12 sm:mt-16 lg:mt-20">
      <div className="relative z-10 w-full max-w-360 mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
