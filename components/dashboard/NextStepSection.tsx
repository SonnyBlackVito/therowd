...
function NextStepCard({ icon, title, time, href }: NextStepCardProps) {
  return (
    <Link
      href={href}
      className="group relative flex flex-col items-center rounded-xl border border-white/20 bg-gradient-to-b from-[#2A2A2A] to-[#1E1E1E] p-8 transition-all duration-300 hover:border-white/40 hover:shadow-lg">
