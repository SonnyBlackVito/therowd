...
export default function VentureFundsContent() {
  ...
  const allProjects = [...projects, ...projects, ...projects].slice(0, 9);
  ...
  return (
    <div className="flex w-full flex-col gap-6 py-8">
      <div className="flex flex-wrap items-center gap-4">
        {['Funding Status', 'Fund Type', 'Geographical Focus', 'Sector Focus'].map(
          (label) => (
