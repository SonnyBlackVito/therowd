  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#060C3C]">
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6">
          <div className="text-center">
            <motion.h1
              ...
              className="text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] font-bold mb-[20px] sm:mb-[22px] bg-gradient-to-r from-[#60A5E0] to-[#36E8CA] bg-clip-text text-transparent"
            >
            ...
            >
              ...
              >
                <span className="font-semibold">Access</span> exclusive private market deals.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                className="text-[15px] sm:text-[18px] md:text-[20px]"
              >
                <span className="font-semibold">Invest</span> in pre-vetted startups, targeted venture funds and a range of alternatives.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                className="text-[15px] sm:text-[18px] md:text-[20px]"
              >
                <span className="font-semibold">Join</span> high net worth investors in private equity, private credit, and other alternative assets.
              </motion.p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="relative w-full sm:-mt-40 lg:-mt-48">
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 h-full flex items-center justify-center pt-8 sm:pt-12">
          <motion.div
