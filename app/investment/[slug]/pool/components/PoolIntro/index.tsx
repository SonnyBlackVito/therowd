...
export default function PoolIntro({
  ...
  return (
    <div
      className="rounded-3xl border p-4 sm:p-5 md:p-5"
      style={{
        borderColor: "#D5E0F5",
        background:
        ...
        <div className="flex items-start gap-3 sm:gap-4 md:gap-5">
          ...
          <div className="flex-1 space-y-2 sm:space-y-3 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-base sm:text-lg font-semibold text-white wrap-break-word">
                {project.name}
              </h1>
            ...
            <div>
              <Badge className="bg-white/10 border-white/20 text-white text-xs">
                {project.tier}
              </Badge>
            </div>
